        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#336633" size="+1" face="Georgia, Times New Roman, Times, serif"><img src="images/key.png" width="35" height="35" />Patient
              Login</font></strong> <br><br><br> <form name="s" action="patient_log1.jsp" method="get" onsubmit="return valid()">
            ...
            <td width="147" bgcolor="#F3ECC2"> <table>
                ...
                <tr>
                  <td align="center"><font face="Comic Sans MS" size="+1"><strong><a href="patient_log.jsp">Outpatient</a></strong></font></td>
                </tr>
                <tr></tr>
                <tr></tr>
                <tr></tr>
...
<%--                <tr> --%>
<%--                  <td align="center"><font face="Comic Sans MS" size="+1"><a href="#">Patient</a></font></td>--%>
<%--                </tr>--%>
<%--                <tr> --%>
