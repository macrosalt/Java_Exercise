...
String u3=request.getQueryString();
        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#336633" size="+1" face="Georgia, Times New Roman, Times, serif"><img src="images/key.png" width="35" height="35" />&nbsp;Inpatient
              Signup</font></strong> <br> <form name="s" action="edit_patient1.jsp" method="get" onsubmit="return valid()">
                <table align="left" cellpadding="5" cellspacing="5" width="300">
                  <tr> 
                    <td colspan="2" align="center"><font size="2"><b> 
                      <%
                                                       ...
                                                       {
                                                               out.println("<font color='red' size='+1'><blink>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Success! Wait for treatment.</blink></font>");
                                                       }
                                               %>
                      </b></font></td>
                  </tr>
                  ...
                  <tr> 
                    <td><font face="Courier New" size="+1"><strong>Inpatient Name</strong></font></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="un" id="b"></td>
                  </tr>
                  <tr> 
                    <td><font face="Courier New" size="+1"><strong>Treatment Name</strong></font></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="cn" id="b"></td>
                  </tr>
                  <tr>
                    <tr>
                        <td><font face="Courier New" size="+1"><strong>Price</strong></font></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="number" name="price" value="0" id="b"></td>
                    </tr>
            ...
            <td width="147" bgcolor="#F3ECC2"> <table>
                ...
                <tr> 
                  <td align="center"><font face="Comic Sans MS" size="+1"><strong><a href="inpatient_signup.jsp">Inpatient</a></strong></font></td>
                </tr>
<%--                <tr> --%>
...
<%--                </tr>--%>
                ...
                <tr> 
                  <td align="center"><font face="Comic Sans MS" size="+1"><a href="patient_log.jsp">Outpatient</a></font></td>
                </tr>
                <tr> 
