...
<div id="wrapper">
    ...
    <div id="navbar">
        <ul>
            ...
            <li><a href="admin_patient.jsp">Patient</a></li>
            ...
            <table height="350" align="center" width="700">
                <tr bgcolor="#CC3300">
                    <td width="610" bgcolor="#FBF7E1" valign="top">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font color="#FF0000" size="+1" face="Courier New"><strong>Laboratory</strong></font> <br><br><br>
<%--                        <form name="f" action="off_search.jsp" method="post" onsubmit="return valid()">--%>
                            <table bgcolor="#FFFFFF" width="700" border="0">

                                <tr bgcolor="#E4E4F1">
                                    <td align="center"><strong></strong></td>
                                    <td align="center"> <font color="#110022"><strong>Total Number</strong></font></td>
                                    <td align="center"><font color="#110022"><strong>Total Cost</strong></font></td>
                                </tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        String qry = "select * from patient where authorize='" + tr + "'";
                                ...
                                %>
                                <tr bgcolor="#FFFFCC">
                                    <td align="center" bgcolor="#E4E4F1"> <strong><font> Inpatients
                                    </font></strong></td>
                                    <td align="center"><strong><font color="#6300C6"> <%=count%>
                                    </font></strong></td>
                                ...
                                %>
                                <tr bgcolor="#FFFFCC">
                                    <td align="center" bgcolor="#E4E4F1"> <strong><font> Outpatients
                                    </font></strong></td>
                                    <td align="center"><strong><font color="#6300C6"> <%=count%>
                                    </font></strong></td>
                                    <td align="center"><strong><font color="#6300C6"> <%=cost%>
