        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
			...
			<font color="#FF0000" size="+1" face="Courier New"><strong>New 
              Inpatients</strong></font> <br><br><br>
              <form name="f" action="off_search.jsp" method="post" onsubmit="return valid()">
                <table bgcolor="#FFFFFF" width="700" border="0">
                  ...
                  <tr bgcolor="#E4E4F1"> 
                    ...
                    <td align="center"><font color="#110022"><strong>Treated</strong></font></td>
                  </tr>
                  <%
			
			
			
			String name=null,cid=null,cname=null,ph=null,email=null,price=null,da=null;
ResultSet rs=null;
...
%>
                  <tr bgcolor="#FFFFCC"> 
                    ...
                    <td align="center"><a href="set_autho.jsp?<%=cid%>"><font color="#FF0000" size="+1">Pass<strong>
                      </strong></font></a></td>
                  </tr>
                  <%	  
}
 ...
 %>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="admin_all_patient.jsp"><font color="#FF0000" size="+1" face="Courier New"><strong>View All Patients</strong></font></a> <br><br><br>
