...
psmt1=con.prepareStatement("insert into patient(uid,name,cname,userid,pass,mobile,email,price,date,authorize) values(?,?,?,?,?,?,?,?,?,?)");
...
psmt1.executeUpdate();
response.sendRedirect("inpatient_signup.jsp?message=success");
