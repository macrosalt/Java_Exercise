...
psmt1=con.prepareStatement("update patient set name=?, cname=?, userid=?, pass=?, mobile=?, email=?, price=?, date=?, authorize=? where uid=?");
...
psmt1.setString(9,ff);
psmt1.setString(10,u3);

psmt1.executeUpdate();
response.sendRedirect("edit_patient.jsp?message=success");
